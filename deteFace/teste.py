...
# Endereço IP do ESP32-CAM
esp32_cam_ip = '192.168.1.80'

# URL de streaming do ESP32-CAM
...
# Libera a conexão com a câmera e fecha a janela
cap.release()
...
face_classifier = cv2.CascadeClassifier('haarcascade_frontalface.xml') # insert the full path to haarcascade file if you encounter any problem
